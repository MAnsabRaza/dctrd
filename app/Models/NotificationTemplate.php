...
class NotificationTemplate extends Model
{
    ...
    static $notificationTemplateAssignSetting = [
        ...
        'registration_package' => ['registration_package_activated', 'registration_package_qactivated_for_admin', 'registration_package_expired'],

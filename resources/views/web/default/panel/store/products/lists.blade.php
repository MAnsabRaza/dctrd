...
@section('content')
    ...
    <section class="mt-25">
        ...
        {{-- ++++++++++++++++++++++++ Export Excel ++++++++++++++++++++++++ --}}
        <a href="{{ route('instructor.products.export') }}" class="btn btn-primary">
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                @if(!empty(session()->has('success')))
                    <div class="alert alert-success my-25 text-white bg-success" 
                         style="background-color: #47c363 !important;">
                        {{ session()->get('success') }}
                    </div>
                @endif
                @if ($errors->any())
                ...
                @endif
                {{-- +++++++++++++++++++++ import Excel +++++++++++++++++ --}}
                <form method="post" action="{{ route('instructor.products.import') }}" enctype="multipart/form-data" class="mt-3" id="excelImportForm">
                    {{ csrf_field() }}
                    <section>
                ...
                @include('web.default.panel.store.products.excel_instructions')
            </div>
        </div>
    </section>
@endsection

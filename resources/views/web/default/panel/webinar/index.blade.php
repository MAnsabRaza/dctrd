...
@section('content')
    ...
    <section class="mt-25">
        ...
        @if(!empty($webinars) and !$webinars->isEmpty())
            ...
            @endif
            <form method="post" action="{{ route('organization_instructor.webinars.import') }}" enctype="multipart/form-data" class="mt-3" id="excelImportForm">
                {{ csrf_field() }}
                <section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 my-1">
                            <button type="submit" class="btn btn-primary btn-sm"  style="margin-top:35px !important;">
            ...
            @include('web.default.panel.webinar.excel_instructions')

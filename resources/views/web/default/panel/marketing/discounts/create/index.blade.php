    ...
    <script src="/assets/default/js/admin/discount.min.js"></script>
     ...
     {{-- <script>
        $(document).ready(function ()
        {
            ...
            {
                var selectedSource = $('.js-discount-source').val();
                if (selectedSource === 'product')
                {
                    $('.js-products-section').slideDown();
                }
                else
                {
                    $('.js-products-section').slideUp();
                }
            }
            // Run on page load in case "product" is pre-selected
            toggleProductsSection();
            // Run on change event
            $('.js-discount-source').change(function ()
            {
                toggleProductsSection();
            });
        });

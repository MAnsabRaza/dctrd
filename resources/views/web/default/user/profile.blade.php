...
@section('content')
    ...
    <div class="container mt-30">
        <section class="rounded-lg border px-10 pb-35 pt-5 position-relative">
            ...
            <li class="nav-item mr-20 mr-lg-50 mt-30">
                @php
                    $user = \App\User::find(request()->segment(2));
                @endphp

                @if($user && $user->role_name == 'organization' && request()->segment(2) == $user->id)
                    <a class="position-relative text-dark-blue font-weight-500 font-16 {{ (request()->get('tab') == 'frontend_connection') ? 'active' : ''  }}" id="frontend_connection-tab" data-toggle="tab" href="#frontend_connection" role="tab" aria-controls="frontend_connection" aria-selected="false">{{ trans('site.frontend_iframe_conncection') }}</a>
                @endif
            </li>
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade px-20 px-lg-50 {{ (request()->get('tab') == 'frontend_connection') ? 'show active' : ''  }}" id="frontend_connection" role="tabpanel" aria-labelledby="frontend_connection-tab">
                    @include('web.default.user.profile_tabs.frontend_iframe_connection')
                </div>
            </div>
        </section>
    </div>

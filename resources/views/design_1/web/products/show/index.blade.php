...
@section('content')
    <div class="container mt-160 mb-160">
        ...
        @include('design_1.web.products.show.includes.about', ['product' => $product])

        {{-- Specifications --}}
        @include('design_1.web.products.show.includes.specifications.index', [
        ...
        @if(!empty($product->files) and count($product->files))
            <div class="mt-24">
                @include('design_1.web.products.show.includes.files', ['product' => $product])
            </div>
        @endif

        {{-- Seller / Instructor Card --}}
        @include('design_1.web.products.show.includes.seller', [
            'product' => $product,
            'seller' => $seller,
        ...
        {{-- Reviews --}}
        <div class="mt-24">
            @include('design_1.web.products.show.includes.reviews', [
                'product' => $product,
        ...
        {{-- Comments --}}
        <div class="mt-24">
            @include('design_1.web.products.show.includes.comments', [
                'product' => $product,

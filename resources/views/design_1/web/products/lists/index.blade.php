...
document.addEventListener('DOMContentLoaded', function () {
    var btnGeo    = document.getElementById('btn-product-use-my-location');
    var inputLat  = document.getElementById('product-filter-lat');
    var inputLng  = document.getElementById('product-filter-lng');
    var addrInput = document.getElementById('product-location-address-input');

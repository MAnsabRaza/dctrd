...
<div class="js-currency-select theme-header-1__dropdown position-relative">
    ...
    <div class="header-1-dropdown-menu py-8">
        ...
        @foreach($currencyItems as $currencyItem)
            ...
            <div class="js-currency-dropdown-item header-1-dropdown-menu__item cursor-pointer {{ (strtoupper($userCurrency) == strtoupper($currencyItem->currency)) ? 'active' : '' }}" data-value="{{ $currencyItem->currency }}" data-title="{{ $currencyItem->currency }}">

@php
    ...
    $isUserProfile = preg_match('#^users/[^/]+/profile$#', $currentPath);
@endphp
...
@if(!empty($themeFooterData['contents']))
    ...
    <div class="theme-footer-2 position-relative js-profile-footer-toggle-target" @if($isUserProfile) style="display: none;" @endif>
    ...
    @if($isUserProfile)
        <button id="profileFooterToggleBtn"
                type="button"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const toggleButton = document.getElementById("profileFooterToggleBtn");
            const footerTargets = document.querySelectorAll(".js-profile-footer-toggle-target");

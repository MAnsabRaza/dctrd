...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var btnGeo   = document.getElementById('btn-use-my-location');
    var inputLat = document.getElementById('filter-lat');
    var inputLng = document.getElementById('filter-lng');
    var addrInput = document.getElementById('location-address-input');
        ...
        btnGeo.addEventListener('click', function () {
            ...
            navigator.geolocation.getCurrentPosition(
                function (pos) {
                    ...
                    // Auto-trigger the listing refresh (same mechanism as other filters)
    ...
    // Manual address → lat/lng via browser Geocoding API (requires HTTPS)
    // Agar OpenStreetMap Nominatim use karna ho:
    if (addrInput) {
        var debounceTimer;

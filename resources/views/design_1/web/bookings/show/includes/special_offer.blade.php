@if(!empty($activeSpecialOffer))
    <div class="product-show__special-offer-card mb-16">
        <div class="position-relative d-flex align-items-center justify-content-between bg-white p-16 pl-12 border-gray-200 rounded-24 w-100 h-100 z-index-2">
            ...
            @php $remainingTimes = $activeSpecialOffer->getRemainingTimes(); @endphp

            <div id="offerCountDown"
                 class="time-counter-down d-flex flex-column justify-content-center p-12 rounded-8 border-gray-200"
                ...
                <div class="d-flex align-items-center font-14 font-weight-bold w-100">
                    <span class="days">0</span><span class="mx-4">:</span>
                    <span class="hours">0</span><span class="mx-4">:</span>
                    <span class="minutes">0</span><span class="mx-4">:</span>

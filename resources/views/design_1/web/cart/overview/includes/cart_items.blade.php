{{--
    ...
    Booking items show:
      - slot date/time (stored in cart meta / session) in Date & Time column
      - logged-in user name in Staff column
      - plain card (no green border)
    Price = booking->discount_price ?? booking->price (same as list page)
--}}

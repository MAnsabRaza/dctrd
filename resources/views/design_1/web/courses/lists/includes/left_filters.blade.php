<div class="position-relative courses-lists-filters">
    ...
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="font-14 font-weight-bold text-dark cursor-pointer"
             href="#courseLocationFilter" data-parent="#leftFiltersAccordion"
    ...
    <div id="courseLocationFilter" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">

        <button type="button" id="btn-course-use-my-location"
        ...
        <div class="form-group mt-12 mb-0">
            <input type="text"
                   id="course-location-address-input"
        ...
        <input type="hidden" name="lat" id="course-filter-lat"
               value="{{ request('lat') }}" class="js-range-input-view-data">
        <input type="hidden" name="lng" id="course-filter-lng"

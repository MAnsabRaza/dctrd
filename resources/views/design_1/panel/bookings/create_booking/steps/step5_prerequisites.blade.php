{{--
    Step 5 of 8 — Prerequisites & Related
    Maps to Image 7: free-text prerequisite note + multi-select of related bookings.
--}}
@php
    $relatedIds = old('related_booking_ids', $booking->meta['related_booking_ids'] ?? []);
    $allBookings = \App\Models\Booking::query()
...
<form data-wiz-form id="stepPrerequisitesForm">
                ...
                <div class="card-body">
                    ...
                    @if($allBookings->isEmpty())
                        <div class="text-center text-muted py-4">
                            No other bookings available yet.
                        </div>
                    @else
                        <div class="form-group" style="max-height:260px; overflow-y:auto;">
                            @foreach($allBookings as $related)

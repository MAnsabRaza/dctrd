<tr>
    ...
    <td class=" text-left">
        ...
        <span class="d-block font-12 text-gray-500">{{ $order->quantity }} {{ trans('update.booking') }}</span>
    </td>
    ...
    <td class="text-center">
        ...
        @else
            <span>{{ trans('update.booking') }}</span>
        @endif
    </td>
            ...
            <div class="actions-dropdown__dropdown-menu dropdown-menu-width-220 dropdown-menu-top-32">
                <ul class="my-8">
                    ...
                    <li class="actions-dropdown__dropdown-menu-item">
                        <a href="/panel/bookings/sales/{{ $order->sale_id }}/bookingOrder/{{ $order->id }}/invoice" class="" target="_blank">{{ trans('public.invoice') }}</a>
                    </li>

...
@section('content')
    ...
    {{-- Top Stats --}}
    @include('design_1.panel.bookings.sales.top_stats')
    ...
    @if(!empty($orders) and !$orders->isEmpty())
        <div class="bg-white pt-16 rounded-24 mt-20">
            ...
            {{-- Filters --}}
            @include('design_1.panel.bookings.sales.filters')

            {{-- List Table --}}
            <div id="tableListContainer" class="table-responsive-lg" data-view-data-path="/panel/bookings/sales">
                <table class="table panel-table">
                    ...
                    @foreach($orders as $order)
                        @include('design_1.panel.bookings.sales.table_items', ['order' => $order])
                    @endforeach
                    </tbody>
                </table>
    ...
    @else
        @include('design_1.panel.includes.no-result',[
            ...
            'title' => trans('update.booking_sales_no_result'),
            'hint' => nl2br(trans('update.booking_sales_no_result_hint')),
        ])
    @endif
...
@push('scripts_bottom')
    ...
    <script src="/assets/design_1/js/panel/booking_sale.min.js"></script>
@endpush
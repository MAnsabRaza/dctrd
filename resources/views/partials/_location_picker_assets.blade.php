            ...
            (function () {
                window.RocketLocationPicker = window.RocketLocationPicker || {
                    ...
                    init: function (root) {
                        ...
                        var lat = parseFloat(latInput ? latInput.value : 0) || 33.6844;
                        var lng = parseFloat(lngInput ? lngInput.value : 0) || 73.0479;
                        var map = L.map(mapEl).setView([lat, lng], (latInput && latInput.value && lngInput && lngInput.value) ? 13 : 5);
                        ...
                        marker.on('dragend', function () {
                            ...
                            if (latInput) latInput.value = point.lat.toFixed(8);
                            if (lngInput) lngInput.value = point.lng.toFixed(8);
                        ...
                        if (saveButton) {
                            saveButton.addEventListener('click', function () {
                                ...
                                payload.append('address_line', addressInput ? addressInput.value : '');
                                payload.append('city', cityInput ? cityInput.value : '');
                                payload.append('state', stateInput ? stateInput.value : '');
                                payload.append('country', countryInput ? countryInput.value : '');
                                payload.append('postal_code', postalInput ? postalInput.value : '');
                                payload.append('lat', latInput ? latInput.value : '');
                                payload.append('lng', lngInput ? lngInput.value : '');

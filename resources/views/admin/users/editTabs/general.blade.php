<div class="tab-pane mt-3 fade @if(empty($becomeInstructor) and (empty(request()->get('tab')))) active show @endif"
            ...
            <form action="{{ getAdminPanelUrl() }}/users/{{ $user->id . '/update' }}" method="Post">
                ...
                <div class="form-group">
                    ...
                    <textarea name="bio" rows="3"
                        class="form-control @error('bio') is-invalid @enderror">{{ $user->bio }}</textarea>
                    @error('bio')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group custom-switches-stacked mt-2">
                    <label class="custom-switch pl-0">
                        ...
                        <input type="checkbox" name="can_create_store" id="canCreateStoreSwitch" value="1" {{ (!empty($user) and $user->can_create_store) ? 'checked="checked"' : '' }}
                            class="custom-switch-input" />
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer"
                            for="canCreateStoreSwitch">{{ trans('update.store') }}</label>
                    </label>
                    <div class="text-gray-500 text-small">{{ trans('update.admin_user_edit_can_create_store_hint') }}
                    </div>
                </div>
                ...
                <div class="form-group custom-switches-stacked mt-2">
                    <label class="custom-switch pl-0">
                        ...
                        <input type="checkbox" name="access_content" id="contentAccessLimitationSwitch" value="0" {{ (!empty($user) and !$user->access_content) ? 'checked="checked"' : '' }}
                            class="custom-switch-input" />
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer"
                ...
                <div class="form-group custom-switches-stacked mt-2">
                    <label class="custom-switch pl-0">
                        ...
                        <input type="checkbox" name="public_message" id="publicMessageSwitch" value="1" {{ (!empty($user) and $user->public_message) ? 'checked="checked"' : '' }}
                            class="custom-switch-input" />
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer"
                            for="publicMessageSwitch">{{ trans('update.enable_profile_messages') }}</label>
                    </label>
                    <div class="text-gray-500 text-small">
                        {{ trans('update.admin_user_edit_enable_profile_messages_hint') }}</div>
                </div>

                <div class="form-group custom-switches-stacked mt-2">
                    <label class="custom-switch pl-0">
                        <input type="hidden" name="enable_profile_statistics" value="0">
                        <input type="checkbox" name="enable_profile_statistics" id="enableProfileStatisticsSwitch"
                            value="1" {{ (!empty($user) and $user->enable_profile_statistics) ? 'checked="checked"' : '' }} class="custom-switch-input" />
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer"
                            for="enableProfileStatisticsSwitch">{{ trans('update.enable_profile_statistics') }}</label>
                    </label>
                    <div class="text-gray-500 text-small">
                        {{ trans('update.admin_user_edit_enable_profile_statistics_hint') }}</div>
                </div>

                <div class="form-group custom-switches-stacked mt-2">
                    <label class="custom-switch pl-0">
                        <input type="hidden" name="auto_renew_subscription" value="0">
                        <input type="checkbox" name="auto_renew_subscription" id="autoRenewSubscriptionSwitch" value="1"
                            {{ (!empty($user) and $user->auto_renew_subscription) ? 'checked="checked"' : '' }}
                            class="custom-switch-input" />
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer"
                    ...
                    <div class="text-gray-500 text-small">
                        {{ trans('update.admin_user_edit_auto_renew_subscription_hint') }}</div>
                </div>
                ...
                @if(!empty($user) and !$user->isUser())
                    <div class="form-group custom-switches-stacked mt-2">
                        <label class="custom-switch pl-0">
                            ...
                            <input type="checkbox" name="enable_ai_content" id="aiContentLimitationSwitch" value="1" {{ (!empty($user) and $user->enable_ai_content) ? 'checked="checked"' : '' }}
                                class="custom-switch-input" />
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer"
                                for="aiContentLimitationSwitch">{{ trans('update.enable_ai_content') }}</label>
                        </label>
                        <div class="text-gray-500 text-small">{{ trans('update.admin_user_edit_enable_ai_content_hint') }}
                        </div>
                    </div>
                @endif

<div class="tab-pane mt-0 fade {{ (request()->get('tab') == 'purchased_products') ? 'active show' : '' }}" id="purchased_products" role="tabpanel" aria-labelledby="purchased_products-tab">
    <div class="row">

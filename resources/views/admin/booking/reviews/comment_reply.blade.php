                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header flex-column align-items-start">
                            ...
                            @if(!empty($review->comments) && $review->comments->count() > 0)
                        ...
                        @can('admin_booking_reviews_reply')
                            <div class="card-body">
                                <form action="{{ getAdminPanelUrl("/comments/product_reviews/{$review->id}/reply") }}"
                                      method="post">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group mt-15">
                                        ...
                                        <textarea id="summernote" name="comment"
                                                  class="summernote form-control @error('comment') is-invalid @enderror">
                                            {!! old('comment') !!}
                                        </textarea>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ trans('admin/main.comment') }}</h5>

                    ...
                    <div class="col-md-12">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ (isset($activeTab) and $activeTab == 'new') ? 'active' : '' }}" 
                                   id="new-tab" data-toggle="tab" href="#new" role="tab" aria-controls="new">
                                    <i class="fas fa-plus"></i> {{ trans('admin/main.add_feature_category') }}
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                                        ...
                                        @forelse($items as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ getAdminPanelUrl() }}/booking/feature-categories/{{ $item->id }}/delete" 
                            ...
                            <div class="tab-pane fade {{ (isset($activeTab) and $activeTab == 'new') ? 'show active' : '' }}" 
                                ...
                                <form method="post" 
                                      action="@if(isset($item)){{ getAdminPanelUrl() }}/booking/feature-categories/{{ $item->id }}@else{{ getAdminPanelUrl() }}/booking/feature-categories@endif"
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if(isset($item))
                                            <a href="{{ getAdminPanelUrl() }}/booking/feature-categories" class="btn btn-secondary">
